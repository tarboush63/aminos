...
const KitDetail = () => {
  ...
  const id = params.id;
  const product = id ? kits.find((p) => String(p.id) === String(id)) : undefined;
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3 p-4 bg-destructive/10 border border-destructive/30 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">This product is on sale for a limited time. Buy Now!</p>
                </div>
              </div>
